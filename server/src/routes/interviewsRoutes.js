...
import {createInterview,getInterviewStats,getMyInterviews,getMyInterviewerInterviews,getInterviewRoom, updateInterviewStatus, saveInterviewCode, saveTranscript} from "../controllers/interviewController.js";
...
router.post("/:id/save-transcript", authMiddleware, saveTranscript);
